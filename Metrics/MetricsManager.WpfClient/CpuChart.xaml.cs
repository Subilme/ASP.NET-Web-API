...
namespace MetricsManager.WpfClient
{
    ...
    public partial class CpuChart : UserControl, INotifyPropertyChanged
    {
        ...
        private CPUMetricsClient _cpuMetricsClient;
        ...
        {
            if (_cpuMetricsClient == null)
            {
                AgentsClient agentClient = new AgentsClient("http://localhost:5062/", new HttpClient());
                _cpuMetricsClient = new CPUMetricsClient("http://localhost:5062/", new HttpClient());
            ...
            try
            {
                ...
                CPUMetricsResponse response = await _cpuMetricsClient.GetAllByIdAsync(
                    1,
